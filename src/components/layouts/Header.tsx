      ...
      <div className="w-full h-[100px] flex justify-between items-center border-b border-[#c0c6cb] pt-[30px] pb-[10px] px-[135px]">
        ...
        <div className="flex items-center text-[16px]">
          <div className="px-[30px]">
            <Link to={'/'} className="py-[5px] hover:border-b hover:border-[#7D8184] hover:transition-opacity hover:delay-500 cursor-pointer">
              Home
            </Link>
          </div>
          <div className="px-[30px]">
            <Link to={'contact'} className="py-[5px] hover:border-b hover:border-[#7D8184] hover:transition-opacity hover:delay-500 cursor-pointer">
              Contact
            </Link>
          </div>
          <div className="px-[30px]">
            <Link to={'about'} className="py-[5px] hover:border-b hover:border-[#7D8184] hover:transition-opacity hover:delay-500 cursor-pointer">
              About
            </Link>
          </div>
          <div className="px-[30px]">
